...
class MPII:
    ...
    def __init__(self, data_split):
        ...
        self.img_dir = '/scratch/ozl201/Vision/mpii/'
        self.train_annot_path = '/scratch/ozl201/Vision/mpii/annotation/train.json'
        self.test_annot_path = '/scratch/ozl201/Vision/mpii/annotation/test.json'
        self.joint_num = 16
